...
export const Footer = () => {
  return (
    <WrapFooter>
      <List>
        ...
        <div>
          ...
          <Medsos>
            ...
            <Link
              className="medsos"
              to="https://www.linkedin.com/in/era-studio-6ab902278"
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <Link
              className="medsos"
              to="https://instagram.com/eradio.creative?igshid=NTc4MTIwNjQ2YQ=="
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <p className="cr">Copyright 2023, EraStudio. All Rights Reserved</p>
    </WrapFooter>
  )
}
